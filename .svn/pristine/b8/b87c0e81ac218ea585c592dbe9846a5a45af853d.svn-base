...
var endflag= true;
		...
		gri :[
			'<div id="' + this.calendarId + '" class="gri_dateRangeCalendar">',
				...
				'<div class="gri_dateRangeOptions" '+ (this.mOpts.autoSubmit ? ' style="display:none" ' : '') +'>',
					'<div class="gri_dateRangeInput" id="' + this.dateRangeDiv + '" style="display:none">',
						'<input type="text" style="display:none" class="gri_dateRangeInput" name="' + this.startDateId + '" id="' + this.startDateId + '" value="' + this.mOpts.startDate + '" readonly />',
						'<span id="' + this.mOpts.joinLineId + '"> - </span>',
						'<input type="text" style="display:none" class="gri_dateRangeInput" name="' + this.endDateId + '" id="' + this.endDateId + '" value="' + this.mOpts.endDate + '" readonly /><br />',
					'</div>',
					'<div class="gri_dateRangeInput" id="' + this.dateRangeCompareDiv + '" style="display:none">',
						'<input type="text" style="display:none" class="gri_dateRangeInput" name="' + this.startCompareDateId + '" id="' + this.startCompareDateId + '" value="' + this.mOpts.startCompareDate + '" readonly />',
					...
					'</div>',
					'<div>',
						'<input type="button" style="display:none" name="' + this.submitBtn + '" id="' + this.submitBtn + '" value="确定" />',
				...
				'<div class="ta_calendar_footer cf" '+ (this.mOpts.autoSubmit ? ' style="display:none" ' : '') +'>',
					'<div class="frm_msg">',
						'<div id="' + this.dateRangeDiv + '" style="display:none">',
							'<input type="text" style="display:none" class="ta_ipt_text_s" name="' + this.startDateId + '" id="' + this.startDateId + '" value="' + this.mOpts.startDate + '" readonly />',
							'<span class="' + this.mOpts.joinLineId + '"> - </span>',
							'<input type="text" style="display:none" class="ta_ipt_text_s" name="' + this.endDateId + '" id="' + this.endDateId + '" value="' + this.mOpts.endDate + '" readonly /><br />',
						'</div>',
						'<div id="' + this.dateRangeCompareDiv + '" style="display:none">',
							'<input type="text" style="display:none" class="ta_ipt_text_s" name="' + this.startCompareDateId + '" id="' + this.startCompareDateId + '" value="' + this.mOpts.startCompareDate + '" readonly />',
							'<span class="' + this.mOpts.joinLineId + '"> - </span>',
							'<input type="text" style="display:none" class="ta_ipt_text_s" name="' + this.endCompareDateId + '" id="' + this.endCompareDateId + '" value="' + this.mOpts.endCompareDate + '" readonly />',
						'</div>',
					'</div>',
					'<div class="frm_btn">',
    ...
    $('#' + this.submitBtn).bind('click', function() {
        __method.close(1);
        var st = $(".ta_ipt_text_s").eq(0).val();
        var en = $(".ta_ipt_text_s").eq(1).val(); 
       // getTeamRecord(st,en);
        Status = false;
        $('.currentArea').show();  
...
//				console.log(__method.endDateId);
//				console.log(__method.startDateId);
//				
			}
		}
        return false;
    ...
    $('#' + this.nextMonth).bind('click', function() {
       ...
       console.log(__method.mOpts.endDate)
		__method.init(isCompare);
...
//	            $('#' + __method.endCompareDateId).val('');
    ...
    if(this.endDateId != this.dateInput && this.endCompareDateId != this.dateInput) {
       // console.log("sssss=="  + isNeedCompare );
        
       // console.log("ffffff=="  + isCompare );
        (isNeedCompare && typeof(isCompare) !='undefined') ? this.addCSS(1) : this.addCSS(0);
    
    	//console.log("dddddd=="  + endflag );
	 /*   if (endflag){
			this.addCSS(1);
		}else{;
			this.addCSS(0);
	...
	if(isNeedCompare && typeof(isCompare) !='undefined'){
	   ...
	   if (endflag){
			this.addCSS(1,"dateRangeSelected");
		}else{;
			this.addCSS(0);
		}
...
pickerDateRange.prototype.selectDate = function(ymd) {
   ...
   this.changeInput(this.dateInput);
    ...
    var ymdFormat = this.formatDate(ymd);
 	...
 	console.log("当前选择："+ ymdFormat)
 	
    // start <-> end 切换
    if(this.startDateId == this.dateInput) {
    	
    	console.log('this.startDateId == this.dateInput')
	    ...
	    $('#' + this.mOpts.endDateId).val("");
		console.log($('#' + this.dateInput).val())
		
    } else if(this.endDateId == this.dateInput) {
    	
    	console.log('this.endDateId == this.dateInput')
    	console.log('结束')
    	endflag=true;
        ...
        if('' == $('#' + this.startDateId).val()) {
            this.dateInput = this.startDateId;
            	...
            	$('#' + this.mOpts.startDateId).val("");
    	console.log($('#' + this.mOpts.startDateId).val())
    	...
    	console.log("this.startCompareDateId == this.dateInput" )
    	...
    	console.log("this.endCompareDateId == this.dateInput" )
    	console.log($('#' + this.dateInput).val())
    ...
    console.log("开始时间" +$('#' + this.mOpts.startDateId).val())    
 
    console.log("结束时间 "+$('#' + this.mOpts.endDateId).val())
   // 切换到下一个输入框
//    this.changeInput(this.dateInput);
};
